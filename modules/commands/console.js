...
module.exports.handleEvent = async function ({
  ...
  try {
    ...
    console.log(`${l.hex("#00e600")("|____________________________________|")}
	
${l.hex("#00e600")(`=> `)}${l.hex("#00e600")(`Tên Nhóm: ${p}`)}
${l.hex("#00e600")(`=> `)}${l.hex("#00bfff")(`ID nhóm: ${event.threadID}`)}
${l.hex("#00e600")(`=> `)}${l.hex("#ff1a8c")(`Tên Người dùng: ${q}`)} 
${l.hex("#00e600")(`=> `)}${l.hex("#33ffd6")(`ID người dùng: ${event.senderID}`)}
${l.hex("#00e600")(`=> `)}${l.hex("#ffb366")(`Nội dung: ${r}`)}
${l.hex("#00e600")(`=> `)}${l.hex("#ff6600")(`Thời gian: ${n}`)}
${l.hex("#00e600")("|____________________________________|")}`);
    timeStamp = dateNow;
