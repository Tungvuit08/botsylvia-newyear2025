...
const login = require("./roasted/Fca-Horizon-Remastered-main"); 
...
const { Sequelize, sequelize } = require("./roasted/database");
writeFileSync(global.client.configPath + ".temp", JSON.stringify(global.config, null, 4), 'utf8');
/////////////////////////////////////////
//========= Load language use =========//
/////////////////////////////////////////
const langFile = (readFileSync(`${__dirname}/roasted/languages/${global.config.language || "en"}.lang`, { encoding: 'utf-8' })).split(/\r?\n|\r/);
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        const listener = require('./roasted/listen')(listenerData);
    ...
    try {
        try {
            ...
            const sequelize2 = new Sequelize({
                dialect: "sqlite",
                host: __dirname + '/roasted/datasqlite/antists.sqlite',
                logging: false
            });
        ...
        authentication.sequelize = sequelize;
        const models = require('./roasted/database/model')(authentication);
        const botData = {};
