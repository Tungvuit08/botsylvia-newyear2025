...
module.exports.languages = {
    'vi': {
        'missingKey': '🎀───── •𝒉𝒅𝒔𝒅• ─────🎀\n${global.config.PREFIX}teamtag [tên team] + @tag từng thành viên (2 người trở lên)\n${global.config.PREFIX}teamtag [tên team] + remove → xóa danh sách team\n${global.config.PREFIX}teamtag list → xem danh sách hiện có\n${global.config.PREFIX}teamtag + tên tem => để gọi hồn',
